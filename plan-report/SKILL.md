...
进 Stage 1 之前**先问两个判断题**,如果两个回答都触发"小",**直接退出 skill,不要继续**——这场景不该用 plan-report:
...
→ 上层有架构基线 / 立项书,需要把"v1.0 做什么、分几步"摊开。本 skill 主战场。
...
本 skill 默认"一个负责人主导写一份计划"。**多人协作场景**下(多个 owner、跨部门、需要先开会对齐):
