...
```
你是为云舒做"提示词官方文档与学术派"调研的研究员。
最终产出是一份给云舒系统学习用的 HTML 学习材料，你负责"骨架"部分——
所有教科书必讲的核心方法。
...
```
你是为云舒做"Agent 时代提示词"调研的研究员。这是云舒最关心的切片之一。
最终产出是一份给云舒系统学习用的 HTML 学习材料的"Agent 时代"章节。
...
| Skills | 公开的 Skills repo（云舒自己的 + 其他人的）|
...
- 真实证据：[如有则给，没有则说"待验证"]
- 选题机会：对用户公众号/产品的潜在价值（评级：极金/强金/金）
```
...
主线程根据 Agent A 反馈的"异见点清单"+ 主题领域典型争论，给 Agent E 列出**至少 8-10 个候选议题**，让 Agent E 全扫。
